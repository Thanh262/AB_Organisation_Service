    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefCodes", x => x.RefCodeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RefValueId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefValues", x => x.RefValueId);
                    table.ForeignKey(
                        name: "FK_RefValues_RefCodes_RefCodeId",
                        column: x => x.RefCodeId,
                        principalTable: "RefCodes",
                        principalColumn: "RefCodeId",
                        onDelete: ReferentialAction.Cascade);
                });
