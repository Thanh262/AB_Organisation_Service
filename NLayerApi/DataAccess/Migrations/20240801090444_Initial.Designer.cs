...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240801090444_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Entities.RefCode", b =>
                {
            ...
            modelBuilder.Entity("DataAccess.Entities.RefValue", b =>
                {
                    b.Property<int>("RefValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RefValueId"));
            ...
            modelBuilder.Entity("DataAccess.Entities.RefValue", b =>
                {
                    b.HasOne("DataAccess.Entities.RefCode", "RefCode")
                        .WithMany("RefValues")
                        .HasForeignKey("RefCodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RefCode");
                });
